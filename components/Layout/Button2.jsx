  ...
  return (
    <button
      className={`relative w-${
        width && width
      } inline-flex items-center justify-start px-4 py-1 overflow-hidden border border-solid border-purple-500 font-medium transition-all bg-white rounded hover:bg-white group`}
      onClick={onClick}
    >
