			...
			<div className='flex justify-between'>
				...
				<div className='flex items-center gap-3 text-indigo-500 customTransition'>
					<span className='flex items-center relative hover:bg-indigo-500 hover:text-indigo-100 rounded-full p-1'>
						...
						<h5 className='absolute -top-2 right-0 rounded-full text-pink-500 font-extrabold'>5</h5>
					</span>
					<div className='h-8 w-8 rounded-full'>
						<Image src={profilePic} alt='profile_pic' layout='responsive' className='rounded-full' height={40} width={40} />
					</div>
