	...
	return (
		<div className='bgRegister'>
			...
			<div className='flex justify-center items-center flex-col-reverse h-screen mx-auto w-full md:w-[450px] p-4 md:p-10'>
				<form className='w-full flex flex-col items-center  mx-auto my-4 bg-white md:h-screen mt-32 pt-4 py-8 rounded-lg px-4 space-y-8' onSubmit={handleSubmit(formHandler)}>
					<Link href='/'>
						<div className='flex w-[250px]  items-center gap-5 border border-black  shadow-xl md:pl-2 '>
							<div className='h-8 w-8'>
								<Image src='/logo_pic2.png' alt='logo' className='cursor-pointer h-8 w-8 shadow-2xl md:scale-150 ml-2' width={80} height={80} />
							</div>
							<div className='flex font-extrabold flex-col tracking-wider text-sm'>
								<span className=' text-xl md:text-3xl  text-indigo-900'>First Monie</span>
